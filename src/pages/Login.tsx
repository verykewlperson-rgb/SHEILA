    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      ...
      >
        <div className="text-center mb-8">
          <h1 className="text-3xl font-light text-foreground tracking-tight" style={{ fontFamily: "'Inter', serif" }}>
            हिंदी सीखें
          </h1>
          <p className="text-sm text-muted-foreground mt-2">AI-Powered Language Learning</p>
        </div>
        ...
        <div className="border border-border bg-card p-6">
          ...
          <div className="space-y-3">
            <input
              ...
              className="w-full border border-border bg-background px-3 py-2.5 text-sm text-foreground placeholder:text-muted-foreground outline-none focus:border-muted-foreground transition-colors"
            />
            <input
              type="password"
              value={password}
